...
- **React 19 / Next.js 16** — Default choice for production web apps; App Router, Server Components, streaming
...
> **Version policy:** All models, SDKs, and libraries listed here are version-agnostic. Always use the **latest stable version** at time of use — verify current versions before pinning in a project. Model names change fast; this list says _what tool_, not _which release_.

### LLM APIs & SDKs

- **Anthropic Claude API** — flagship reasoning and speed tiers (use the latest stable Claude models)
- **OpenAI API** — flagship multi-purpose models and reasoning variants (use the latest stable models)
- **Google Gemini** — long context and multimodal (use the latest stable models)
...
- **LangChain (LCEL)** — Pipeline orchestration; use for composability
- **LlamaIndex** — Knowledge retrieval layer; RAG pipelines, document parsing
